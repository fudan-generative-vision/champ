...
<template>
  <div ref="unseenCarousel" id="unseenCarousel" class="relative" data-twe-carousel-init data-twe-ride="carousel">
    ...
    <div class="absolute bottom-0 left-0 right-0 z-[2] mx-[15%] mb-4 flex list-none justify-center p-0"
      ...
      <button type="button" data-twe-target="#unseenCarousel" data-twe-slide-to="1"
        class="mx-[3px] box-content h-[3px] w-[30px] flex-initial cursor-pointer border-0 border-y-[10px] border-solid border-transparent bg-white bg-clip-padding p-0 -indent-[999px] opacity-50 transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none"
    ...
    <button
      ...
      type="button" data-twe-target="#unseenCarousel" data-twe-slide="prev">
    ...
    <button
      ...
      type="button" data-twe-target="#unseenCarousel" data-twe-slide="next">
      <span class="inline-block h-8 w-8">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="h-6 w-6">
